...
public class KonstanteKlijenta {
	...
	public static final int MAKSIMALNA_DUZINA_ADRESA = 120;
	public static final int MAKSIMALNA_DUZINA_EMAIL = 60;
	public static final int MAKSIMALNA_DUZINA_WEB = 60;
}
